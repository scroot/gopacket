	...
	if got, ok := p.Layer(LayerTypeRadioTap).(*RadioTap); ok {
		want := &RadioTap{
			BaseLayer: BaseLayer{
				...
				Payload:  []uint8{0xc4, 0x0, 0x94, 0x0, 0xd8, 0xa2, 0x5e, 0x97, 0x61, 0xc1},
			},
			Version:          0x0,
			Length:           0x19,
			Present:          0x86f,
	...
	if got, ok := p.Layer(LayerTypeDot11).(*Dot11); ok {
		want := &Dot11{
			BaseLayer: BaseLayer{
				...
				Payload: []uint8{
					0x38, 0x40, 0x10, 0x28, 0x0, 0x0, 0x0, 0x0, 0x64, 0x0, 0x0, 0x5, 0x0, 0x0, 0x1, 0x8, 0x8c, 0x12, 0x98, 0x24, 0xb0, 0x48, 0x60, 0x6c, 0x3, 0x1, 0x24, 0x5, 0x4, 0x0, 0x1, 0x0, 0x0, 0x7, 0x2a, 0x55, 0x53, 0x20, 0x24, 0x1, 0x11, 0x28, 0x1, 0x11, 0x2c, 0x1, 0x11, 0x30, 0x1, 0x11, 0x34, 0x1, 0x17, 0x38, 0x1, 0x17, 0x3c, 0x1, 0x17, 0x40, 0x1, 0x17, 0x95, 0x1, 0x1e, 0x99, 0x1, 0x1e, 0x9d, 0x1, 0x1e, 0xa1, 0x1, 0x1e, 0xa5, 0x1, 0x1e, 0x20, 0x1, 0x0, 0xdd, 0x18, 0x0, 0x50, 0xf2, 0x2, 0x1, 0x1, 0x0, 0x0, 0x3, 0xa4, 0x0, 0x0, 0x27, 0xa4, 0x0, 0x0, 0x42, 0x43, 0x5e, 0x0, 0x62, 0x32, 0x2f, 0x0, 0x34, 0xc, 0x66, 0x72, 0x65, 0x65, 0x62, 0x73, 0x64, 0x2d, 0x6d, 0x65, 0x73, 0x68, 0x33, 0x17, 0x1, 0x0, 0xf, 0xac, 0x0, 0x0, 0xf, 0xac, 0x0, 0x0, 0xf, 0xac, 0xff, 0x0, 0xf, 0xac, 0xff, 0x0, 0xf, 0xac, 0xff, 0x0, 0xdf},
			},
...
func TestPacketDot11MgmtAction(t *testing.T) {
	...
	want := "PACKET: 97 bytes\n- Layer 1 (32 bytes) = RadioTap\t{Contents=[..32..] Payload=[..65..] Version=0 Length=32 Present=264295 TSFT=634199967 Flags=SHORT-PREAMBLE,DATAPAD Rate=6 Mb/s ChannelFrequency=0 MHz ChannelFlags= FHSS=0 DBMAntennaSignal=-41 DBMAntennaNoise=-96 LockQuality=0 TxAttenuation=0 DBTxAttenuation=0 DBMTxPower=0 Antenna=1 DBAntennaSignal=0 DBAntennaNoise=0 Checksum=0}\n- Layer 2 (24 bytes) = Dot11\t{Contents=[..24..] Payload=[..41..] Type=MgmtAction Proto=0 Flags= DurationID=0 Address1=ff:ff:ff:ff:ff:ff Address2=00:03:7f:07:a0:16 Address3=00:03:7f:07:a0:16 Address4= SequenceNumber=42 FragmentNumber=0}\n- Layer 3 (41 bytes) = Dot11MgmtAction\t{Contents=[..41..] Payload=[]}\n"
...
func TestPacketDot11CtrlAck(t *testing.T) {
	...
	checkLayers(p, []gopacket.LayerType{LayerTypeRadioTap, LayerTypeDot11, LayerTypeDot11CtrlAck}, t)
	...
	if got, ok := p.Layer(LayerTypeDot11).(*Dot11); ok {
		want := &Dot11{
			BaseLayer: BaseLayer{
				...
				Payload:  []uint8{0x46, 0xe9, 0x76, 0x87},
			},
...
// testPacketPacket1237 is the packet:
//   09:17:04.501727 1.0 Mb/s 2412 MHz 11g -75dB signal antenna 1 Probe Response (Echo Base's Network) [1.0* 2.0* 5.5* 11.0* 6.0 9.0 12.0 18.0 Mbit] CH: 1, PRIVACY
//   	0x0000:  0000 1200 2e48 0000 0002 6c09 c000 b501  .....H....l.....
//   	0x0010:  0000 5008 3a01 1499 e223 71b1 b418 d1e2  ..P.:....#q.....
//   	0x0020:  66a0 b418 d1e2 66a0 f048 4c65 2889 6301  f.....f..HLe(.c.
//   	0x0030:  0000 6400 3114 0013 4563 686f 2042 6173  ..d.1...Echo.Bas
//   	0x0040:  6527 7320 4e65 7477 6f72 6b01 0882 848b  e's.Network.....
//   	0x0050:  960c 1218 2403 0101 0706 4e4c 2001 0d1e  ....$.....NL....
//   	0x0060:  2a01 0032 0430 4860 6c30 1401 0000 0fac  *..2.0H`l0......
//   	0x0070:  0401 0000 0fac 0401 0000 0fac 0200 002d  ...............-
//   	0x0080:  1aad 511b ffff 0000 0000 0000 0000 0000  ..Q.............
//   	0x0090:  0000 0000 0000 0000 0000 0033 0251 063d  ...........3.Q.=
//   	0x00a0:  1601 0011 0000 0000 0000 0000 0000 0000  ................
//   	0x00b0:  0000 0000 0000 0046 0502 0001 0000 dd18  .......F........
//   	0x00c0:  0050 f202 0101 0600 03a4 0000 27a4 0000  .P..........'...
//   	0x00d0:  4243 5e00 6232 2f00 dd07 0003 9301 730b  BC^.b2/.......s.
//   	0x00e0:  20dd 0e00 17f2 0700 0101 06b4 18d1 e266  ...............f
//   	0x00f0:  a0dd 0b00 17f2 0100 0101 0000 0007       ..............
var testPacketPacket1237 = []byte{
	,
}

func TestPacketPacket1237(t *testing.T) {
	p := gopacket.NewPacket(testPacketPacket1237, LinkTypeIEEE80211Radio, gopacket.Default)
	if p.ErrorLayer() != nil {
		t.Error("Failed to decode packet:", p.ErrorLayer().Error())
	}
	checkLayers(p, []gopacket.LayerType{LayerTypeRadioTap, LayerTypeDot11, LayerTypeDot11MgmtProbeResp, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement}, t)
}
func BenchmarkDecodePacketPacket1237(b *testing.B) {
	for i := 0; i < b.N; i++ {
		gopacket.NewPacket(testPacketPacket1237, LinkTypeEthernet, gopacket.NoCopy)
	}
}

// testPacketPacket2223 is the packet:
//   09:17:46.282492 1.0 Mb/s 2412 MHz 11g -71dB signal antenna 1 Probe Request (Echo Base's Network) [1.0 2.0 5.5 6.0 9.0 11.0 12.0 18.0 Mbit]
//   	0x0000:  0000 1200 2e48 0000 0002 6c09 c000 b901  .....H....l.....
//   	0x0010:  0000 4000 0000 ffff ffff ffff 6cad f8c6  ..@.........l...
//   	0x0020:  e869 ffff ffff ffff f008 0013 4563 686f  .i..........Echo
//   	0x0030:  2042 6173 6527 7320 4e65 7477 6f72 6b01  .Base's.Network.
//   	0x0040:  0802 040b 0c12 1618 2403 0101 2d1a 2001  ........$...-...
//   	0x0050:  0300 0000 0000 0000 0000 0000 0000 0000  ................
//   	0x0060:  0000 0000 0000 0000 3204 3048 606c       ........2.0H`l
var testPacketPacket2223 = []byte{
	0x00, 0x00, 0x12, 0x00, 0x2e, 0x48, 0x00, 0x00, 0x00, 0x02, 0x6c, 0x09, 0xc0, 0x00, 0xb9, 0x01,
	0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x6c, 0xad, 0xf8, 0xc6,
	0xe8, 0x69, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xf0, 0x08, 0x00, 0x13, 0x45, 0x63, 0x68, 0x6f,
	0x20, 0x42, 0x61, 0x73, 0x65, 0x27, 0x73, 0x20, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x01,
	0x08, 0x02, 0x04, 0x0b, 0x0c, 0x12, 0x16, 0x18, 0x24, 0x03, 0x01, 0x01, 0x2d, 0x1a, 0x20, 0x01,
	0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x32, 0x04, 0x30, 0x48, 0x60, 0x6c,
}

func TestPacketPacket2223(t *testing.T) {
	p := gopacket.NewPacket(testPacketPacket2223, LinkTypeIEEE80211Radio, gopacket.Default)
	if p.ErrorLayer() != nil {
		t.Error("Failed to decode packet:", p.ErrorLayer().Error())
	}
	checkLayers(p, []gopacket.LayerType{LayerTypeRadioTap, LayerTypeDot11, LayerTypeDot11MgmtProbeReq, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement, LayerTypeDot11InformationElement}, t)
}
func BenchmarkDecodePacketPacket2223(b *testing.B) {
	for i := 0; i < b.N; i++ {
		gopacket.NewPacket(testPacketPacket2223, LinkTypeEthernet, gopacket.NoCopy)
	}
}
